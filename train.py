...
from RnnPoemGen2.read_utils import TextConverter, batch_generator
from RnnPoemGen2.model import CharRNN
import os
import codecs
...
tf.flags.DEFINE_string('input_file', 'data/poetry1.txt', 'utf8 encoded text file')
# tf.flags.DEFINE_integer('max_steps', 5000, 'max steps to train')
tf.flags.DEFINE_integer('max_steps', 5, 'max steps to train')
